...
const Navbar = () => {
    ...
    return (
        ...
        <div className='container text-center my-3'>
            ...
            <button type="button" onClick={() => fetchImageByCategory("computer")} className="btn btn-outline-info mx-3">Computer</button>
            <button type="button" onClick={() => fetchImageByCategory("buildings")} className="btn btn-outline-light mx-3">Buildings</button>
            <button type="button" onClick={() => fetchImageByCategory("sports")} className="btn btn-outline-success mx-3">Sports</button>
            <button type="button" onClick={() => fetchImageByCategory("backgrounds")} className="btn btn-outline-info mx-3">Backgrounds</button>
